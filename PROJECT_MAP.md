...
- **[تعديل 2026-09-22]** رُفع ضباب الخلفية من `blur(6px)` إلى `blur(48px)` (مع `-webkit-`) بحيث يظهر الباك الضبابي بوضوح خلف كامل الشاشة **وحتى خلف النافذة الشفافة** نفسها (لأن `glass-modal` شفافة)، وليس المحيط فقط — بدرجة "سراب" تجعل ملامح النص الخلفي غير قابلة للتمييز. (مرّ بقيم 24px → 20px → 22px → استقرّ على 48px.)
